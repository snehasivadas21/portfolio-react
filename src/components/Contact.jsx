...
const socialLinks = [
  ...
  icon: (
    <svg width="24" height="24" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fill="currentColor" d="M40.72 31.19L29.53 42.5c-1.98 1.98-5.18 1.98-7.16 0l-15-15c-1.98-1.98-1.98-5.18 0-7.16l15-15c1.98-1.98 5.18-1.98 7.16 0L36.06 13 33.9 15.15l-8.36-8.36c-.78-.78-2.04-.78-2.82 0l-15 15c-.78.78-.78 2.04 0 2.82l15 15c.78.78 2.04.78 2.82 0l11.19-11.3z" />
      <path fill="currentColor" d="M21.46 32.96L29.02 25.4 21.46 17.84 23.6 15.7l9.62 9.63-9.63 9.63z" />
    </svg>
  ),
  alt: 'LeetCode'
},
  ...
  return (
    <div>
        ...
        <div className='container lg:grid lg:grid-cols-2 lg:items-stretch'>
            ...
            <form action="https://getform.io/f/bqomvkgb" method="POST" className='xl:pl-10 2xl:pl-20'>
                <div className='md:grid md:items-center md:grid-cols-2 md:gap-2'>
                  <div className='mb-4'>
                    ...
                    <input type="text" name="name" id="name" autoComplete="name" required placeholder="Sneha" className="text-field"/>
                  </div> 
                  <div className='mb-4'>
                    <label
                    htmlFor='email'
                    ...
                    <input type="email" name="email" id="email" autoComplete="email" required placeholder="ssneha2103@gmail.com" className="text-field reveal-up"/>
                  </div> 
